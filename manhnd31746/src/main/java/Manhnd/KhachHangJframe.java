...
public class KhachHangJframe extends javax.swing.JFrame {
    ...
    public KhachHangJframe() {
        initComponents();
        this.khService.insert(new KhachHang("KHv@1", "Nguyễn Hằng", 0, "0987654321", "VIP", 10));
        this.khService.insert(new KhachHang("KHv@1", "Nguyễn Thúy", 1, "0987654321", "Moi", 8));
        this.khService.insert(new KhachHang("KHv@1", "Nguyễn Manh", 0, "0987654321", "Thân Thiết", 5));
        this.khService.insert(new KhachHang("KHv@1", "Nguyễn Huy", 1, "0987654321", "Moi", 8));
        this.khService.insert(new KhachHang("KHv@1", "Nguyễn Nam", 1, "0987654321", "VIP", 8));
        this.loadData();
    }
